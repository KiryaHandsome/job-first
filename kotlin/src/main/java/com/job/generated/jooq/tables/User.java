...
public class User extends TableImpl<UserRecord> {
     ...
     */
    public final TableField<UserRecord, Boolean> EMAIL_VERIFIED = createField(DSL.name("email_verified"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>public.user.role</code>.
     */
    public final TableField<UserRecord, String> ROLE = createField(DSL.name("role"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.user.registered_at_millis</code>.
     */
    public final TableField<UserRecord, Long> REGISTERED_AT_MILLIS = createField(DSL.name("registered_at_millis"), SQLDataType.BIGINT.nullable(false), this, "");
     ...
     */
    public final TableField<UserRecord, String> MIDDLE_NAME = createField(DSL.name("middle_name"), SQLDataType.CLOB, this, "");
